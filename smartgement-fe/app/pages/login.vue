  ...
  <div class="min-h-screen flex items-center justify-center bg-white text-black p-4 font-sans">
    <div class="w-full max-w-md border-2 border-black p-8 bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold uppercase tracking-tighter mb-2">Login</h1>
      ...
      <div class="mt-8 text-center border-t-2 border-gray-100 pt-6">
        <p class="font-medium text-gray-600">Don't have an account? <NuxtLink to="/register" class="text-black font-bold uppercase underline decoration-2 underline-offset-2 hover:bg-black hover:text-white px-1">Register here</NuxtLink></p>
      </div>
    </div>
  </div>
</template>
...
const handleLogin = async () => {
  ...
  try {
    ...
    error.value = err?.data?.error || 'Login failed. Please verify your credentials.'
